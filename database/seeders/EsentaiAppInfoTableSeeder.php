...
class EsentaiAppInfoTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $dataType = DataType::create([
            ...
            'display_name_singular' => 'Esentai App',
            'display_name_plural' => 'Esentai App',
            'icon' => '',
            'model_name' => 'App\\Models\\EsentaiApp',
            'controller' => '',
        ...
        DataRow::create([
            ...
            'field' => 'download_link',
            'type' => 'text',
            'display_name' => 'Ссылка на скачивание',
            'required' => 1,
            'browse' => 1,
            'read' => 1,
            'edit' => 1,
